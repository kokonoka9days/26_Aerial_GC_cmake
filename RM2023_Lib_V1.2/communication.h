...
#include "stdlib.h"
#include "math.h"
#define MINI_PC_RXBUF_SIZE 32 // 数组大小，可修改
#define MINI_PC_TX_BUF_SIZE 37
...
#define MINI_PC_USART_HANDLE huart6 // 串口号，可修改
    extern uint8_t Mini_PC_2rx_buf[2][MINI_PC_RXBUF_SIZE];

    extern uint8_t PC_FIFO;
...
extern USBD_HandleTypeDef hUsbDeviceFS;
    ...
    extern uint8_t Mini_PC_tx_buf[MINI_PC_TX_BUF_SIZE];
    extern uint8_t Mini_PC_rx_buf[MINI_PC_RXBUF_SIZE];
    typedef uint8_t u8;
    typedef union
    {
        float f;
    ...
    typedef struct
    {
        ...
        uint8_t zimiao_status;       // 自瞄   2   1  0
...
#pragma region /*TJ*/
    static const uint8_t CRC8_INIAT = 0xff;
    ...
    extern void TJ_GetReceive_SP(uint8_t(*buf));
...
#pragma endregion /*TJ*/
    ...
    extern uint8_t PC_online;

    extern uint8_t cal_crc_table(uint8_t *ptr, uint8_t len);
    extern void PC_watchdog_run(void);
    extern void Mini_PC_UART_Init(void);
    extern void Mini_PC_SendData();
    // extern void Mini_PC_TJ_SendData();
    extern void Mini_PC_TJ_SendData(uint8_t shubiao_R); // 哨兵第二版
